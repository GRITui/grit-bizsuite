 ...
 *   app.js  APP_VERSION = '0.9.38'
 *   sw.js   SW_VERSION   = 'sidekick-v0.9.38'
 ...
 */
const SW_VERSION = 'sidekick-v0.9.38';
...
const SHELL_ASSETS = [
  ...
  BASE + 'index.html',
  BASE + 'login.html',
  BASE + 'app.js?v=0.9.38',
  BASE + 'dataClient.js?v=0.9.38',
  BASE + 'tax.js?v=0.9.38',
  BASE + 'invoices.js?v=0.9.38',
  BASE + 'docgen.js?v=0.9.38',
  BASE + 'bookings.js?v=0.9.38',
  BASE + 'followups.js?v=0.9.38',
  BASE + 'portfolio.js?v=0.9.38',
  BASE + 'research.js?v=0.9.38',
  BASE + 'styles.css?v=0.9.38',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
