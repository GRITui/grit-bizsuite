// Grit Taskboard — lib/schemaSql.js must stay a VERBATIM copy of
...
assert(SCHEMA_SQL.includes('create table if not exists ops_tasks'),
  'embedded schema carries the ops_tasks table');
